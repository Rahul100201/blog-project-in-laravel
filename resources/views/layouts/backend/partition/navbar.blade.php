        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            @if (Auth::user()->role_id==1)
             <ul class="nav navbar-nav">
                 ...
                 <li class="active">
                    <a href="{{ url('Admin/comment') }}"><i class="menu-icon fa fa-user"></i>Comment</a>
                 </li>
             </ul>
             @else
             <ul class="nav navbar-nav">
                ...
                <h3 class="menu-title">CMS</h3>
                <li class="active">
                   <a href="{{ url('User/comments') }}"><i class="menu-icon fa fa-user"></i>Comments</a>
                </li>
                <li class="active">
                   <a href="{{ url('user/reply_comments') }}"><i class="menu-icon fa fa-user"></i>Category</a>
                </li>
                <li class="active">
                   <a href="{{ url('Admin/Post') }}"><i class="menu-icon fa fa-user"></i>Post</a>
                </li>
